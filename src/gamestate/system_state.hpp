...
struct user_settings_s {
	...
	uint8_t self_message_settings[int32_t(sys::message_setting_type::count)] = {
		...
		message_response::standard_popup,//peace_accepted_by_nation = 16,
		message_response::standard_popup,//peace_rejected_by_nation = 17,
		...
		message_response::standard_popup,//ally_called_accepted_by_nation = 56,
...
struct cheat_data_s {
	...
	dcon::commodity_id foundry_market_live_commodity;
	uint64_t foundry_market_live_runs = 0;
	uint64_t foundry_market_live_failures = 0;
	uint64_t foundry_market_live_comparisons = 0;
	std::vector<dcon::market_id> foundry_market_live_markets;
	std::vector<dcon::commodity_id> foundry_market_basket_commodities;
	std::vector<float> foundry_market_basket_supply;
	std::vector<float> foundry_market_basket_demand;
	...
	float foundry_market_basket_latest_unsold_delta = 0.f;
	float foundry_market_basket_worst_delta = 0.f;
	std::array<float, 4> foundry_market_basket_category_delta{};
	...
	float foundry_market_vanilla_consumption = 0.f;
	float foundry_market_routed_unmet = 0.f;
	float foundry_market_routed_unsold = 0.f;
	float foundry_market_latest_consumption_delta = 0.f;
	float foundry_market_latest_unmet_delta = 0.f;
	float foundry_market_latest_unsold_delta = 0.f;
	double foundry_market_sum_abs_consumption_delta = 0.0;
	double foundry_market_sum_abs_unmet_delta = 0.0;
	double foundry_market_sum_abs_unsold_delta = 0.0;
