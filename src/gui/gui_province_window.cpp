...
void province_view_window::on_create(sys::state& state) noexcept {
	window_element_base::on_create(state);
...
void province_view_window::set_active_province(sys::state& state, dcon::province_id map_province) {
...
void province_view_window::on_update(sys::state& state) noexcept {
