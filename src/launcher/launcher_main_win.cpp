...
void render() {
	...
	launcher::ogl::render_new_text("Foundry", launcher::ogl::color_modification::none, 83, 5, 26, launcher::ogl::color3f{ 255.0f / 255.0f, 230.0f / 255.0f, 153.0f / 255.0f }, launcher::ogl::fonts[1]);
