...
TRIGGER_BYTECODE_ELEMENT(0x02E7, is_colonial_crisis, 0) \
TRIGGER_BYTECODE_ELEMENT(0x02E8, province_population_growth_province, 2) \
...
constexpr inline uint16_t first_scope_code = 0x02E9;
