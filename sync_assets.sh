#!/usr/bin/env bash
# Shared runtime-asset sync for the Victoria 2 install this machine points at.
# Sourced by launch.sh and launch_webui.sh -- do not run standalone as the only
# place these get updated; keep both callers pointed at this one file instead
# of copy-pasting the list (see docs/FOUNDRY_UI_WINDOW_GUIDE.md's "Runtime asset
# synchronization" section for why forgetting a sync entry is easy to mistake
# for a code bug).
set -euo pipefail
...
cmake -E copy_if_different "$FOUNDRY_DIR/assets/foundry_topbar.gfx" "$V2_DIR/assets/foundry_topbar.gfx"
...
cmake -E make_directory "$V2_DIR/assets/fonts/foundry"
cmake -E copy_directory "$FOUNDRY_DIR/assets/fonts/foundry" "$V2_DIR/assets/fonts/foundry"
cmake -E copy_directory "$FOUNDRY_DIR/assets/localisation" "$V2_DIR/assets/localisation"
...
cmake -E copy_if_different "$FOUNDRY_DIR/assets/foundry_ui/controls/foundry_time_up_24x24_v1.png" "$V2_DIR/assets/foundry_ui/controls/foundry_time_up_24x24_v1.png"
cmake -E copy_if_different "$FOUNDRY_DIR/assets/foundry_ui/controls/foundry_time_down_24x24_v1.png" "$V2_DIR/assets/foundry_ui/controls/foundry_time_down_24x24_v1.png"
cmake -E copy_if_different "$FOUNDRY_DIR/assets/foundry_ui/controls/foundry_time_pause_24x24_v1.png" "$V2_DIR/assets/foundry_ui/controls/foundry_time_pause_24x24_v1.png"
cmake -E copy_if_different "$FOUNDRY_DIR/assets/foundry_ui/controls/foundry_time_indicator_24x24_v1.png" "$V2_DIR/assets/foundry_ui/controls/foundry_time_indicator_24x24_v1.png"
...
cmake -E copy_if_different "$FOUNDRY_DIR/mod/Rise of Nations/interface/topbar.gui" "$V2_DIR/interface/topbar.gui"
...
# Phase 1 web UI (see .claude/plans/quiet-puzzling-raven.md) -- served by the
# webapi's static mount at /app, relative to cwd (V2_DIR), not read from the repo.
